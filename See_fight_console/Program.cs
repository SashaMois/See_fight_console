            ...
            */
            ...
            while(ship_count <= 4)
            {
                ...
                for (uint i = 0; i < ship_count; ++i)
                {
                    ...
                    if (ship_length == 3) Console.WriteLine($"Write coordinates for next {i} Cruiser(three deck) ship:");
                    else if (ship_length == 2) Console.WriteLine($"Write coordinates for next {i} Destroyer(two deck) ship:");
                    else if (ship_length == 1) Console.WriteLine($"Write coordinates for next {i} Torpedo Boat(one deck ship):");
